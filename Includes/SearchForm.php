...
include_once('ConnectDB.php');
    ...
    WHERE  requester.user_no='{$_SESSION["user_no"]}' AND requester.ref_no = '$searchRefNo' ";
...
if(mysqli_num_rows($result)>0){
    ...
    <div class='container'>
      <h1 class='display-4'>No ref No $searchRefNo was found</h1>
      <p class='lead'> The ref No does not exist.</p>
